<html>
	...
	<body>
		...
		<nav class="navbar navbar-expand-lg navbar-dark bg-dark static-top">
			<div class="container">
                <a class="navbar-brand" href="index.php">Pagina Viaggio</a>
			...
			<div id="formContent2">
                ...
                <?php
					...
					echo "<tr>
                              ...
                              <th>Motivo          </th>
                              <th>Documento Passeggero          </th>
						  </tr>";

					while($search = mysqli_fetch_array($result))
					{
						print "<tr>" . "<td>$search[Aeroporto_Part]</td>" . "<td>$search[Aeroporto_Dest]</td>" . "<td>$search[motivo]</td>" . "<td>$search[Codice_Passeggero]</td></tr>";
					}
